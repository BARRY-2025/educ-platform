...
const navItems: NavItem[] = [
  ...
  { label: 'Maternelle', path: '/preschool', icon: Baby, roles: ['super_admin', 'admin_etablissement', 'enseignant', 'parent'] },
  ...
  { label: 'Mes bulletins', path: '/my-grades', icon: FileText, roles: ['parent'] },
  { label: 'Évaluations', path: '/preschool/evaluation', icon: FileText, roles: ['super_admin', 'admin_etablissement', 'enseignant'] },
  { label: 'Bulletins', path: '/preschool/bulletins', icon: FileText, roles: ['super_admin', 'admin_etablissement'] },
